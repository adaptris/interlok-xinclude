...
/**
 * Custom {@link com.adaptris.core.config.ConfigPreProcessor} implementation that supports xinclude directives as part of the adapter
 * configuration file.
 * <p>
 * This ConfigurationPreProcessor can be activated by the setting or appending to the bootstrap property
 * {@value com.adaptris.core.management.AdapterConfigManager#CONFIGURATION_PRE_PROCESSORS} to be <strong>xinclude</strong> and making sure
 * the required jars are available on the classpath.
 * </p>
 * <p>
 * It is only useful if you are not using the UI to create configuration, as that will always create a monolithic configuration file. It
 * uses the <a href="https://xerces.apache.org/xerces2-j/features.html#xinclude">XInclude feature</a> of Xerces-J.
 * </p>
 *
 * @author amcgrath
 *
